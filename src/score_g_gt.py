...
parser.add_argument(
    "--feat", 
    type=str,  
    help="choices in ['g_2', 'g_4', 'g_6', 'g_8', 'g_10', 'g_12']",
)
...
# Load 73k NSD images
f = h5py.File(f'{data_path}/{args.feat}_all.hdf5', 'r')
...
Y_te = np.stack([images[i] for i in test_unique_idx]).squeeze()

savedir_scores = f"../scores_all/GT/g/Linear-{args.feat.split('_')[1]}"
