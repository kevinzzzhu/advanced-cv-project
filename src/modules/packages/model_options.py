...
import numpy as np
import os, sys, torch
root = '/home/kevin/Documents/ACV/Project/advanced-cv-project'
import importlib.util
from warnings import filterwarnings

model_typology = pd.read_csv( root+'/src/modules/packages/model_typology.csv')
...
def get_clip_transforms(model_name, input_type = 'PIL'):
    # 这里CPU改了GPU
    import open_clip; model, _, preprocess = open_clip.create_model_and_transforms(model_name, pretrained='openai')
    if input_type == 'PIL':
